...
export function CrearPartidoAmigo({ grupoId, onClose, onCreated }: CrearPartidoAmigoProps) {
    ...
    const handleAgregarJugador = async () => {
        ...
        setGuardando(true)
        try {
            const jugador = await agregarJugador(partidoId, nuevoNombre.trim(), equipoAgregando)
                    ...
                    {paso === 1 ? (
                        ...
                        >
                            ...
                            <TeamSection
                                ...
                                onAgregar={() => setEquipoAgregando('azul')}
                            ...
                            <TeamSection
                                ...
                                onAgregar={() => setEquipoAgregando('rojo')}
                                onEliminar={handleEliminarJugador}
                            />
                        ...
                        >
                            ...
                            >
                                ...
                                <input
                                    ...
                                    autoFocus
                                    className="w-full bg-[var(--input-bg)] border border-[var(--card-border)] rounded-xl p-3 text-sm mb-3 focus:outline-none focus:ring-2 focus:ring-[#10b981]/50"
                                />
                                <div className="flex gap-2">
                                    <button
                                        onClick={() => { setEquipoAgregando(null); setNuevoNombre('') }}
